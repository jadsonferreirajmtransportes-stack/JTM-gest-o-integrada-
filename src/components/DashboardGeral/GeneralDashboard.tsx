              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {userRole !== 'colaborador' && onOpenAdmissionLink && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 text-xs font-semibold transition-all shadow-xs"
                    title="Gerar link de pré-admissão digital para novo colaborador"
                  >
                    <UserCheck className="w-3.5 h-3.5 text-[#8A6A39]" />
