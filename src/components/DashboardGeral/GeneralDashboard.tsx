...
export const GeneralDashboard: React.FC<GeneralDashboardProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200 pb-12">
      ...
      {/* ========================================================================= */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#111111] via-[#1a1714] to-[#262017] text-white p-6 sm:p-8 shadow-xl border border-[#B38F4F]/30">
        {/* Decorative Golden Light accents */}
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#B38F4F]/20 text-[#D8B97E] border border-[#B38F4F]/40 text-xs font-bold tracking-wide">
                  <LayoutDashboard className="w-3.5 h-3.5 text-[#B38F4F]" />
                  Torre de Controle Executiva • Painel Geral
                </span>
                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[11px] font-semibold">
              ...
              <p className="text-sm text-slate-300 max-w-3xl font-normal leading-relaxed mt-1">
            ...
            <div className="flex flex-wrap items-center gap-2 shrink-0">
              <button
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-xl bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-200 border border-indigo-500/40 text-xs font-bold transition-all shadow-xs"
              >
          ...
          {/* INTEGRATED GLOBAL SEARCH BAR & ACTION BUTTONS */}
          <div className="pt-4 border-t border-white/10 space-y-4">
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
              {/* Prominent Global Search Input */}
              <div className="relative flex-1 max-w-2xl">
                <div className="relative flex items-center bg-white/10 hover:bg-white/15 focus-within:bg-white/20 rounded-xl px-3.5 py-2.5 border border-white/20 transition-colors">
                  <Search className="w-4 h-4 text-[#D8B97E] mr-2.5 shrink-0" />
                  <input
                  ...
                  {searchQuery ? (
                    ...
                    <kbd className="text-[10px] bg-black/40 border border-white/20 px-1.5 py-0.5 rounded font-mono text-slate-300 shrink-0 ml-1">
                      ⌘K
                    </kbd>
                  )}
                </div>
              ...
              {/* ACTION BUTTONS (As requested by the user: "adicione também os botões de ação e busca que estão no topo da página") */}
              <div className="flex flex-wrap items-center gap-2">
                ...
                {userRole === 'admin' && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#B38F4F] hover:bg-[#8A6A39] text-white text-xs font-bold transition-all shadow-xs"
                ...
                {userRole !== 'colaborador' && onOpenAdmissionLink && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/20 text-xs font-semibold transition-all shadow-xs"
                    title="Gerar link de pré-admissão digital para novo colaborador"
                  >
                    <UserCheck className="w-3.5 h-3.5 text-[#D8B97E]" />
                    <span>Link Admissão</span>
                  </button>
                )}
                ...
                <div className="relative">
                  ...
                  {isDbMenuOpen && (
                    <div className="absolute right-0 mt-2 w-60 bg-white text-slate-800 rounded-xl shadow-2xl border border-slate-200 py-1.5 z-50 text-xs animate-in fade-in zoom-in-95 duration-100">
      ...
      <StrategicGuidelinesBanner variant="dark" />
