              ...
              return (
                <div key={p.id} className="space-y-2 group">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="font-bold text-slate-900 hover:text-purple-700 transition-colors text-left"
                      >
                        {p.titulo}
                      </button>
                    </div>
                  ...
                  <div className="relative h-7 bg-slate-100 rounded-lg overflow-hidden border border-slate-200">
                    ...
                    <div
                      className="absolute top-1 bottom-1 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-md shadow-xs flex items-center justify-between px-2 text-white text-[10px] font-bold transition-all duration-300 group-hover:brightness-110"
                      style={{
                        left: `${startPct}%`,
                        width: `${widthPct}%`,
                      }}
