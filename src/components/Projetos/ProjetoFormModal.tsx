      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center text-[#C48229]">
              <FolderKanban className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
                {initialData ? 'Editar Projeto Gerencial' : 'Novo Projeto Estratégico & Gerencial'}
                <span className="text-xs font-mono font-normal px-2 py-0.5 rounded bg-slate-100 text-[#92611F] border border-slate-200">
                  {codigo || 'PRJ-2026'}
                </span>
              </h2>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <div className="space-y-4 animate-in fade-in duration-150">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs font-mono font-bold focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs font-semibold focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs bg-white focus:ring-2 focus:ring-[#C48229] focus:outline-hidden font-medium"
                  >
                    {CATEGORIAS.map((c) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs bg-white focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                  >
                    {SETORES.map((st) => (
                ...
                <div className="flex flex-wrap gap-1.5">
                  {supervisores.map((sup) => (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-md text-[11px] bg-slate-100 hover:bg-amber-100 text-slate-700 hover:text-[#92611F] border border-slate-200 transition-colors"
                    >
                      + {sup.nome}
                    </button>
                  ))}
              ...
              <div className="p-4 bg-amber-50/60 rounded-xl border border-amber-200 space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-bold text-[#5c4526] flex items-center gap-1.5">
                    <Target className="w-4 h-4 text-[#C48229]" />
                    Progresso Geral Realizado:
                  </label>
                  <span className="text-sm font-extrabold text-[#92611F] font-mono">
                    {progressoPercentual}%
                  </span>
                </div>
                <input
                  ...
                  className="w-full h-2 bg-amber-200 rounded-lg appearance-none cursor-pointer accent-[#C48229]"
                />
                <div className="flex justify-between text-[10px] text-[#92611F] font-medium">
                  <span>0% (Início)</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs font-mono focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                  />
                </div>
            ...
            <div className="space-y-4 animate-in fade-in duration-150">
              <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                <h4 className="text-xs font-bold text-slate-800 flex items-center gap-1.5">
                  <Plus className="w-4 h-4 text-[#C48229]" />
                  ...
                  marcos.map((marco, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <span className="w-5 h-5 rounded-full bg-amber-100 text-[#92611F] font-bold text-[10px] flex items-center justify-center shrink-0">
                          {idx + 1}
                        </span>
            ...
            <div className="space-y-4 animate-in fade-in duration-150">
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-1.5 border border-slate-300 rounded-lg text-xs bg-white focus:ring-2 focus:ring-[#C48229] focus:outline-hidden"
                    >
                ...
                >
                  ...
                  />
                  <div className="w-10 h-10 rounded-full bg-amber-100 text-[#C48229] flex items-center justify-center mb-2">
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            {(doc.url || doc.arquivoUrl) && (
                              <a
                                ...
                                download={doc.nome}
                                className="p-1.5 text-slate-500 hover:text-[#C48229] hover:bg-slate-100 rounded-lg transition-colors"
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
            ...
            <button
              type="submit"
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#C48229] to-[#C48229] hover:from-[#92611F] hover:to-[#92611F] text-white font-bold text-xs rounded-xl shadow-md transition-all shadow-[#C48229]/20"
            >
