        ...
        <div className="jmt-print-doc flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {activeTab === 'visao_geral' && (
            <div className="space-y-6 animate-in fade-in duration-150">
              ...
              {onOpenResumo && (
                <div className="p-4 bg-gradient-to-r from-emerald-50 via-teal-50 to-amber-50 rounded-xl border border-emerald-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
                  <div className="flex items-center gap-3">
                    ...
                    {projeto.documentos.slice(0, 3).map((doc) => {
                      ...
                      return (
                        <div
                          key={doc.id}
                          onClick={() => setActiveTab('documentos')}
                          className="p-3 bg-slate-50 hover:bg-amber-50/50 rounded-xl border border-slate-200 hover:border-amber-300 transition-all cursor-pointer flex items-center gap-3"
                        >
