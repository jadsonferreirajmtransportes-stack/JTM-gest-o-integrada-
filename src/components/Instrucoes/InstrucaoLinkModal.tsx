    ...
    <div className="fixed inset-0 z-[80] overflow-y-auto bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-6 text-slate-300">
          <div className="flex items-start gap-2.5 bg-slate-950/60 p-3.5 rounded-2xl border border-slate-800 text-[11px] text-slate-400 leading-relaxed">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-slate-950 p-3 rounded-xl border border-slate-800 font-mono text-xs text-emerald-400 break-all select-all flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-950/60 p-4 rounded-2xl border border-slate-800 flex flex-col justify-between space-y-3">
              <div>
                <div className="flex items-center gap-2 text-xs font-bold text-emerald-400 mb-1">
                  <Send className="w-4 h-4" />
                  <span>Enviar pelo WhatsApp</span>
                </div>
                <p className="text-[11px] text-slate-400">Informe o número com DDD ou clique para abrir a conversa</p>
                <input
                  type="text"
                  placeholder="(84) 99999-0000"
                  value={destinatarioTelefone}
                  onChange={(e) => setDestinatarioTelefone(e.target.value)}
                  className="w-full mt-2 p-2 bg-slate-900 border border-slate-700 rounded-lg text-xs text-white"
                />
              </div>
              <div className="flex items-center gap-2 pt-2">
                ...
                >
                  {messageCopied ? <CheckCircle2 className="w-4 h-4 text-emerald-400" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
        ...
        <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-amber-300 rounded-xl text-xs font-bold flex items-center gap-1.5 border border-slate-700 transition-colors"
          >
