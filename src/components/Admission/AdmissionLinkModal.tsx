  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Modal Header */}
        <div className="bg-[#0c0c0c] border-b border-[#262626] p-5 text-white flex items-center justify-between relative overflow-hidden">
          <div className="flex items-center gap-3.5 relative z-10">
            <div className="w-11 h-11 rounded-xl bg-[#161616] border border-[#B38F4F]/40 flex items-center justify-center text-[#B38F4F] shadow-inner">
              <Share2 className="w-5 h-5 text-[#B38F4F]" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-white tracking-tight">Link de Admissão & Auto-Cadastro</h2>
                <span className="bg-[#B38F4F]/20 text-[#B38F4F] border border-[#B38F4F]/30 text-[10px] px-2 py-0.5 rounded-full font-bold">
                  JMT Digital
                </span>
              </div>
        ...
        {/* Modal Content */}
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto custom-scrollbar-dark">
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div>
                <label className="block text-slate-400 mb-1">Nome do Candidato</label>
                <input
                  type="text"
                  value={candidateName}
              ...
              <div>
                <label className="block text-slate-400 mb-1">WhatsApp do Candidato (com DDD)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-400 mb-1">Empresa Contratante</label>
                <select
              ...
              <div>
                <label className="block text-slate-400 mb-1">Cargo Pretendido</label>
                <select
                  value={selectedCargo}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1.5 flex items-center justify-between">
              <span className="flex items-center gap-1.5">
                <LinkIcon className="w-3.5 h-3.5 text-[#B38F4F]" />
                Link Direto para o Colaborador
              </span>
              <span className="text-[10px] text-slate-500">Pronto para compartilhamento</span>
            </label>
            <div className="flex items-center gap-2">
              <input
                type="text"
                readOnly
                value={generatedLink}
                className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-xs text-[#F4EEE1] font-mono select-all focus:outline-hidden"
              />
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button
              ...
              className="p-4 bg-emerald-950/30 hover:bg-emerald-900/40 border border-emerald-500/30 rounded-2xl flex flex-col items-center text-center transition-all group"
            >
              ...
              <span className="text-xs font-bold text-white">Enviar no WhatsApp</span>
              <span className="text-[10px] text-emerald-300 mt-0.5">Mensagem formatada pronta</span>
            </button>
            ...
            <button
              ...
              className="p-4 bg-blue-950/30 hover:bg-blue-900/40 border border-blue-500/30 rounded-2xl flex flex-col items-center text-center transition-all group"
            >
              ...
              <span className="text-xs font-bold text-white">Enviar por E-mail</span>
              <span className="text-[10px] text-blue-300 mt-0.5">Com instruções formais</span>
            </button>
            ...
            <button
              ...
              className="p-4 bg-[#1e1a14] hover:bg-[#252019] border border-[#B38F4F]/30 rounded-2xl flex flex-col items-center text-center transition-all group"
            >
              <div className="w-10 h-10 rounded-xl bg-[#B38F4F]/20 text-[#B38F4F] flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                <ExternalLink className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold text-white">Testar Formulário</span>
              <span className="text-[10px] text-[#B38F4F] mt-0.5">Ver visão do candidato</span>
            </button>
          </div>
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-slate-300">Mensagem que será enviada:</span>
              <button
                type="button"
                onClick={handleCopyMessage}
                className="text-[11px] text-[#B38F4F] hover:text-[#F4EEE1] flex items-center gap-1 font-semibold"
              >
                {messageCopied ? <Check className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
                <span>{messageCopied ? 'Texto copiado!' : 'Copiar texto'}</span>
              </button>
            </div>
            <pre className="text-xs text-slate-300 font-sans whitespace-pre-wrap bg-slate-900 p-3 rounded-xl border border-slate-800 max-h-36 overflow-y-auto leading-relaxed">
              {whatsappMessage}
            </pre>
          </div>
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 flex flex-col sm:flex-row items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-1.5 text-xs font-bold text-white mb-1">
                <QrCode className="w-4 h-4 text-[#B38F4F]" />
