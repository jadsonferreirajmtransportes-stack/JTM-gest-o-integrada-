      ...
      <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-white border-b border-slate-100 p-5 flex items-center justify-between relative overflow-hidden">
          <div className="flex items-center gap-3.5 relative z-10">
            <div className="w-11 h-11 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center text-[#8A6A39] shadow-inner">
              <Share2 className="w-5 h-5 text-[#8A6A39]" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-slate-900 tracking-tight">Link de Admissão & Auto-Cadastro</h2>
                <span className="bg-amber-50 text-[#8A6A39] border border-amber-200 text-[10px] px-2 py-0.5 rounded-full font-bold">
                  JMT Digital
                </span>
              </div>
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4">
            <span className="text-xs font-bold text-[#8A6A39] uppercase tracking-wider block mb-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1.5 flex items-center justify-between">
              <span className="flex items-center gap-1.5">
                <LinkIcon className="w-3.5 h-3.5 text-[#8A6A39]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-amber-100 text-[#8A6A39] flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                <ExternalLink className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold text-slate-900">Testar Formulário</span>
              <span className="text-[10px] text-[#8A6A39] mt-0.5">Ver visão do candidato</span>
            </button>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-[11px] text-[#8A6A39] hover:text-[#B38F4F] flex items-center gap-1 font-semibold"
              >
