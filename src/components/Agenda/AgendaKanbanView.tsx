            ...
            <div className="flex items-center justify-between pb-3 mb-2 border-b border-slate-200">
              ...
              {col.status === 'Agendada' && (
                <button
                  ...
                  className="p-1 text-slate-400 hover:text-[#C48229] hover:bg-slate-200/60 rounded-md transition-colors"
                ...
                return (
                  ...
                  >
                    ...
                    <h4
                      ...
                      className="text-xs font-bold text-slate-900 hover:text-[#C48229] transition-colors cursor-pointer leading-snug line-clamp-2"
                    >
                      {atv.titulo}
                    </h4>
                    ...
                    {atv.deliberacoes && atv.deliberacoes.length > 0 && (
                      <div className="mt-2 pt-1.5 border-t border-slate-100 flex items-center justify-between text-[10px] text-[#C48229] font-semibold">
                    ...
                    <div className="mt-2.5 pt-2 border-t border-slate-100 flex items-center justify-between gap-1">
                      ...
                      <button
                        type="button"
                        onClick={() => onSelectAtividade(atv)}
                        className="text-[10px] font-semibold text-[#C48229] hover:underline"
                      >
                        Detalhes
                      </button>
                      ...
                      <div>
                        {next && (
                          <button
                            ...
                            className="p-1 text-[#C48229] hover:text-[#92611F] hover:bg-amber-50 rounded-md transition-colors text-[10px] font-semibold flex items-center gap-0.5"
