        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-xs text-slate-800 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#C48229]"
            />
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap text-xs">
            ...
            <div className="inline-flex bg-slate-200/60 p-0.5 rounded-lg">
              ...
              <button
                ...
                className={`px-2.5 py-1 text-xs font-medium rounded-md transition-colors ${
                  periodoFilter === 'hoje'
                    ? 'bg-white text-[#92611F] shadow-2xs font-semibold'
                    : 'text-slate-600 hover:text-slate-900'
                }`}
              >
            ...
            <select
              ...
              className="px-2.5 py-1 bg-white border border-slate-300 rounded-lg text-xs text-slate-700 focus:outline-hidden focus:ring-2 focus:ring-[#C48229]"
            >
              ...
              >
                ...
                <div
                  className={`w-14 h-14 rounded-xl flex flex-col items-center justify-center shrink-0 border relative ${
                    isToday
                      ? 'bg-[#C48229] text-white border-[#92611F] shadow-xs'
                  ...
                  {multiDia && (
                    <ArrowLeftRight
                      className={`w-3 h-3 absolute -top-1.5 -right-1.5 rounded-full p-0.5 ${
                        isToday ? 'bg-[#92611F] text-white' : 'bg-[#C48229] text-white'
                      }`}
                    />
                  )}
                ...
                <div className="space-y-1 min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {isToday && (
                      <span className="px-2 py-0.5 text-[10px] bg-amber-100 text-[#92611F] font-bold rounded-md animate-pulse">
                        HOJE
                      </span>
                    )}
                    {multiDia && (
                      <span className="px-2 py-0.5 text-[10px] bg-amber-50 text-[#92611F] border border-amber-200 font-semibold rounded-md flex items-center gap-1">
