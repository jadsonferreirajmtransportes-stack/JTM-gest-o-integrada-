      ...
      <div className="px-4 py-3.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-semibold bg-[#B38F4F] hover:bg-[#8A6A39] text-white rounded-lg shadow-xs flex items-center gap-1.5 transition-colors"
          >
                ...
                >
                  <div className="flex items-start justify-between gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {isAtividadeMultiDia(atv) && (
                        <span className="px-2.5 py-1 bg-amber-50 text-[#8A6A39] border border-amber-200 font-bold text-xs rounded-lg flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold bg-amber-50 hover:bg-amber-100 text-[#8A6A39] rounded-lg transition-colors"
                      >
                        Ver Detalhes
                      </button>
                    </div>
                  ...
                  <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 flex-wrap gap-2">
                    ...
                    {atv.deliberacoes && atv.deliberacoes.length > 0 && (
                      <span className="text-[#B38F4F] font-semibold text-[11px]">
