      ...
      <div className="px-4 py-3.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-semibold bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-xs flex items-center gap-1.5 transition-colors"
          >
        ...
        {dayAtividades.length > 0 ? (
                  ...
                  <div className="flex items-start justify-between gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {isAtividadeMultiDia(atv) && (
                        <span className="px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-200 font-bold text-xs rounded-lg flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg transition-colors"
                      >
                        Ver Detalhes
                      </button>
                    </div>
          ...
          <div className="py-16 text-center border-2 border-dashed border-slate-200 rounded-2xl">
            ...
            <button
              type="button"
              onClick={() => onNewAtividadeDate(dateStr)}
              className="px-4 py-2 text-xs font-semibold bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-xs inline-flex items-center gap-2 transition-colors"
            >
