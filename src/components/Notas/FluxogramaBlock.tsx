  ...
  return (
    <div
      className={`group relative min-w-[130px] rounded-xl border-2 bg-white px-3.5 py-2.5 text-center shadow-xs transition-colors ${
        selected ? 'border-teal-500 shadow-md' : 'border-slate-300'
      }`}
    >
      <Handle type="target" position={Position.Top} className="!w-2 !h-2 !bg-teal-500 !border-white" />
      <Handle
        type="target"
        position={Position.Left}
        id="left-target"
        className="!w-2 !h-2 !bg-teal-500 !border-white"
      />
      <textarea
        value={data.label}
      ...
      <Handle type="source" position={Position.Bottom} className="!w-2 !h-2 !bg-teal-500 !border-white" />
      <Handle
        type="source"
    ...
    <div className="rounded-xl border border-slate-200 overflow-hidden">
      <div className="flex items-center justify-between px-3 py-1.5 bg-slate-50 border-b border-slate-200">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-lg px-2 py-1 text-[11px] font-semibold text-teal-700 transition-colors hover:bg-teal-50 hover:text-teal-800"
        >
