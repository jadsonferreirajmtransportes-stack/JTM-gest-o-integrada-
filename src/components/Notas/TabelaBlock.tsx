  ...
  return (
    <div className="rounded-xl border border-slate-200 overflow-x-auto">
          ...
          <tr className="bg-slate-50">
            ...
            <th className="w-8 border border-slate-200 bg-slate-50">
              <button
                ...
                className="flex h-full w-full items-center justify-center py-2 text-slate-400 transition-colors hover:text-teal-600"
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-1 border-t border-slate-200 py-1.5 text-[11px] font-semibold text-slate-400 transition-colors hover:bg-teal-50/40 hover:text-teal-600"
      >
        <Plus className="w-3.5 h-3.5" />
        Adicionar linha
      </button>
