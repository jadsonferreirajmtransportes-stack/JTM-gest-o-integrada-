      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="jmt-print-doc p-6 overflow-y-auto space-y-6 flex-1 bg-slate-50/50">
            ...
            <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs space-y-2">
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="flex justify-between py-1 border-b border-slate-100">
                  ...
                  <span className="font-semibold text-blue-700">{embarque.previsaoEntregaDestino}</span>
                </div>
                <div className="flex justify-between py-1">
          ...
          <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs space-y-3">
            ...
            {isAddingLog && (
              <form onSubmit={handleAddLog} className="p-3 bg-blue-50/70 border border-blue-200 rounded-xl space-y-2.5 animate-fade-in">
            ...
            <div className="space-y-3 relative before:absolute before:inset-0 before:left-3.5 before:w-0.5 before:bg-slate-200">
              {embarque.historico.map((hist, idx) => (
                <div key={hist.id || idx} className="relative flex items-start gap-3.5 pl-1">
                  <div className="w-6 h-6 rounded-full bg-white border-2 border-blue-600 flex items-center justify-center z-10 shrink-0 shadow-xs">
