          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-amber-50 text-[#92611F] border border-amber-200">
        ...
        <div className="jmt-print-doc p-6 overflow-y-auto space-y-6 flex-1 bg-slate-50/50">
          ...
          <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col items-center px-4">
              <div className="flex items-center gap-2 text-xs font-semibold text-[#C48229]">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto text-right md:text-left justify-end md:justify-start">
              ...
              <div className="w-10 h-10 rounded-lg bg-amber-50 text-[#92611F] border border-amber-200 flex items-center justify-center font-bold">
            ...
            <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-slate-700 flex items-center gap-1.5">
                  <Thermometer className="w-4 h-4 text-[#C48229]" />
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-xl font-bold font-mono text-[#92611F]">
            ...
            <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs space-y-2">
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="flex justify-between py-1 border-b border-slate-100">
                  ...
                  <span className="font-semibold text-[#92611F]">{embarque.previsaoEntregaDestino}</span>
                </div>
                <div className="flex justify-between py-1">
              ...
              {(
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors border ${
                    embarque.status === st
                      ? 'bg-[#C48229] text-white border-[#C48229] shadow-xs'
          ...
          <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-800 flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-[#C48229]" />
                Linha do Tempo de Rastreamento Térmico & Aeroportuário
              </span>
              <button
                onClick={() => setIsAddingLog(!isAddingLog)}
                className="inline-flex items-center gap-1 text-xs font-semibold text-[#C48229] hover:text-[#92611F]"
              >
            ...
            {isAddingLog && (
              <form onSubmit={handleAddLog} className="p-3 bg-amber-50/70 border border-amber-200 rounded-xl space-y-2.5 animate-fade-in">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-3 py-1 text-xs font-semibold text-white bg-[#C48229] hover:bg-[#92611F] rounded-md"
                  >
                    Salvar Evento
                  </button>
                </div>
            ...
            <div className="space-y-3 relative before:absolute before:inset-0 before:left-3.5 before:w-0.5 before:bg-slate-200">
              {embarque.historico.map((hist, idx) => (
                <div key={hist.id || idx} className="relative flex items-start gap-3.5 pl-1">
                  <div className="w-6 h-6 rounded-full bg-white border-2 border-[#C48229] flex items-center justify-center z-10 shrink-0 shadow-xs">
                    <span className="w-2 h-2 rounded-full bg-[#C48229]" />
                  </div>
